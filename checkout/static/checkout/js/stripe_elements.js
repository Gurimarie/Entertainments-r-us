...
form.addEventListener('submit', function(ev) {
    /* 
    prevents the form from submitting, disables the card-element,
    ...
    */
    ...
    /* 
    create variables to capture the form-data we can't put in the 
    payment_intent_view 
    */
    ...
    /* 
    when paymentintent is updated and returns a 200-response,
    we call the confirmCardPayment-method, and if OK; submit the form
    */
